...
const colors = {
  ...
  sky: 'bg-primary-500/15 text-primary-700 group-data-[hover]:bg-primary-500/25 dark:bg-primary-500/10 dark:text-primary-300 dark:group-data-[hover]:bg-primary-500/20',

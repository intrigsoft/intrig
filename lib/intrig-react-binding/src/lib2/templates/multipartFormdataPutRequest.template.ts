...
export function multipartFormDataPutRequestTemplate({source, paths, operationId, response, requestUrl, variables, sourcePath, requestBody}: RequestProperties): CompiledOutput {

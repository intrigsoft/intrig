 ...
 */
export function useNetworkState<T>(key: string, operation: string, source: string, debounceDelay: number | undefined): [NetworkState<T>, (request: AxiosRequestConfig) => void, clear: () => void] {
